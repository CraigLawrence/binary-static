...
const Tac = () => (
    <div>
        ...
        <p><i>{it.L('Date effective 2018-04-10.')}</i></p>
        ...
        <p>{it.L('Persons with insider knowledge of any financial market or instrument are prohibited from trading at this website.')}</p>
